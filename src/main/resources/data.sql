...
insert into paginas_moulo (id_modulo, label, url, icono) values (1, 'Listar Modulos', '/modulos', 'list');
insert into paginas_moulo (id_modulo, label, url, icono) values (1, 'Crear Modulos', '/modulos/crear', 'save');
insert into paginas_moulo (id_modulo, label, url, icono) values (2, 'Listar Roles', '/roles', 'list');
insert into paginas_moulo (id_modulo, label, url, icono) values (2, 'Crear Roles', '/roles/crear', 'save');
insert into paginas_moulo (id_modulo, label, url, icono) values (3, 'Listar Usuarios', '/usuarios', 'list');
insert into paginas_moulo (id_modulo, label, url, icono) values (3, 'Crear Usuarios', '/usuarios/crear', 'save');
insert into paginas_moulo (id_modulo, label, url, icono) values (4, 'Listar Paginas', '/paginas', 'list');
insert into paginas_moulo (id_modulo, label, url, icono) values (4, 'Crear Paginas', '/paginas/crear', 'save');
...
insert into paginas_roles (id_pagina_modulo, id_rol) values (7, 1);
insert into paginas_roles (id_pagina_modulo, id_rol) values (8, 1);
