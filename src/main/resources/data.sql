...
insert into modulos (id_modulo, nombre, label, icono) values (3, 'Servicio Areas', 'Modulos', 'folder');
...
insert into paginas_moulo (id_pagina_modulo, id_modulo, label, url, icono) values (3, 3, 'Admin Areas', '/modulos', 'list');
