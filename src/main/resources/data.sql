...
insert into paginas_moulo (id_pagina_modulo, id_modulo, label, url, icono) values (4, 3, 'Crear Modulos', '/modulos/crear', 'save');
insert into paginas_moulo (id_pagina_modulo, id_modulo, label, url, icono) values (5, 1, 'Crear Roles', '/roles/crear', 'save');
...
insert into paginas_roles (id_pagina_rol, id_pagina_modulo, id_rol) values (6, 3, 2);
